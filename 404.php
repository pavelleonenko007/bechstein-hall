...
<body <?php body_class( 'body black-theme' ); ?>>
	...
	<main class="wrapper _404wrp">
		<section class="section _404sec wf-section">
			<img src="<?php echo esc_url( get_template_directory_uri() . '/images/404.png' ); ?>" loading="lazy" alt class="image-7">
			<div class="div-block-25">
					<div class="_404txt">404</div>
					<div class="text-block-9">page not found</div>
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="link-20 white _404-page">go to main page</a>
			</div>
		</section>
	</main>
